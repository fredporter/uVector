...
class TestNanoBanana(unittest.TestCase):
    def test_presets_exist(self):
        ...
        self.assertIn("mono_amber", STYLE_PRESETS)
    ...
    def test_client_fallback_offline(self):
        ...
        res = client.generate("Cyberpunk skyline", style_preset="mono_amber")
        self.assertEqual(res["status"], "success")
        self.assertEqual(res["model"], "imagen-3.0-generate-002")
        self.assertEqual(res["style_preset"], "mono_amber")
        self.assertEqual(res["aspect_ratio"], "4:3")
